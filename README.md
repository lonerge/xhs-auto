# ✨ XHS-Auto (小红书自动化工具) | 适用App版本: 8.51.0及以上

欢迎使用 **XHS-Auto**，这是一款基于无障碍服务，安全稳定，可长期运行。旨在自动化操作小红书，培养账号兴趣定位并帮助您提升账号权重并实现各种自动化操作。

最近更新: 视频帖子发布; UI布局; 自动发帖(图片); 滑动轨迹改为随机曲线; 点击操作改为范围内随机偏移
...
### ✍️ 功能二: 自动发帖 (开发中...)
- 目前支持图片帖子和视频帖子
- 需要给软件权限比如: 无障碍 媒体资源访问权限
- 支持编辑标题 文案 话题(多个话题用空格隔开) 
- 支持输入图片/视频链接, 自动下载图片资源, 然后发布
- 支持读取本地图片/视频, 需要给出完整路径, 然后发布
